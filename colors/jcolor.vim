...
call jcolor#highlight('xKeyword', s:palette.xKeyword, s:palette.none)
...
call jcolor#highlight('xTypeDecl', s:palette.xTypeDecl, s:palette.none, 'bold,italic')
call jcolor#highlight('xOtherDecl', s:palette.xOtherDecl, s:palette.none, 'bold')
